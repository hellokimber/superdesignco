import imgT1 from '../assets/imgs/SuperDesign_product_diorspec.webp'
import imgT2 from '../assets/imgs/SuperDesign_Cairn-no1_landscape.webp'
...
export const HOME_GRID = [
  ...
  // Mixed sequence to avoid long editorial-only runs below the hero.
  {
    area: 't1',
    src: imgT1,
    alt: 'Product still life with eyewear',
    width: 2064,
    height: 2752,
  },
  {
  ...
  },
  {
    area: 't3',
    src: imgT3,
    alt: 'Yellow motorcycle helmet with visor',
    width: 1600,
    height: 893,
  },
  {
  ...
  },
  {
    area: 't5',
    src: imgT5,
    alt: 'Motorcycle helmet, alternate angle',
    width: 1856,
    height: 2304,
  },
  {
  ...
  },
  {
    area: 't9',
    src: imgT9,
    alt: 'Beauty portrait with luxury branding',
    width: 928,
    height: 1137,
  },
  {
